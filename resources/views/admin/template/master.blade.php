            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('adminProductCreate') }}" class="nav-link"><i class="fas fa-plus"></i><span>新增商品</span></a>

                        </li>
                        <li class="nav-item">
                            <a href="{{ route('adminProductIndex') }}" class="nav-link"><i
                                    class="fas fa-th"></i> <span>商品列表</span></a>
                        </li>
                        <li class="menu-header">分類管理</li>
                        <li class="nav-item">
                            <a href="{{ route('adminCategoryCreate') }}" class="nav-link"><i class="fas fa-plus"></i> <span>新增分類</span></a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('adminCategoryIndex') }}" class="nav-link"><i class="fas fa-clipboard-list"></i> <span>分類列表</span></a>
                        </li>

                        <li class="menu-header">標籤管理</li>
                        <li class="nav-item">
                            <a href="#" class="nav-link"><i class="fas fa-tags"></i> <span>標籤列表</span></a>
                        </li>
